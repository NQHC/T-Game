...
/**
 * JShape.java: Creates a J shape tetronimo
 *
 * @author Nathan C
...
public class JShape extends Tetronimo {
    ...
    public JShape() {
        ...
        super(null);
        super.color = Color.BLUE; // sets color of shape
    ...
    public Point[] rotateCheck() {
        super.rot = new Point[4];
        if (super.curRotation % 4 == 0) {

            super.rot[0] = new Point(super.s1.getR() - 1, super.s1.getC());
            super.rot[1] = new Point(super.s2.getR(), super.s2.getC() + 1);
            super.rot[2] = new Point(super.s4.getR(), super.s4.getC() + 2);
            super.rot[3] = new Point(super.s3.getR() + 1, super.s3.getC() - 1);
        } else if (super.curRotation % 3 == 0) {

            super.rot[0] = new Point(super.s2.getR() + 1, super.s2.getC() - 2);
            super.rot[1] = new Point(super.s1.getR(), super.s1.getC() - 1);
            super.rot[2] = new Point(super.s4.getR(), super.s4.getC() - 2);
            super.rot[3] = new Point(super.s3.getR() + 2, super.s3.getC() + 1);
        } else if (super.curRotation % 2 == 0) {

            super.rot[0] = new Point(super.s2.getR(), super.s2.getC());
            super.rot[1] = new Point(super.s1.getR(), super.s1.getC());
            super.rot[2] = new Point(super.s4.getR() + 1, super.s4.getC() + 1);
            super.rot[3] = new Point(super.s3.getR() - 1, super.s3.getC() + 1);
        } else {

            super.rot[0] = new Point(super.s2.getR() - 1, super.s2.getC() + 1);
            super.rot[1] = new Point(super.s1.getR() + 1, super.s1.getC() + 1);
            super.rot[2] = new Point(super.s4.getR() - 1, super.s4.getC() - 1);
            super.rot[3] = new Point(super.s3.getR() - 1, super.s3.getC() - 1);
        }
